...
- `?turn(без параметров)`
- `?players(без параметров)`
- `?active_players(без параметров)`
- `?supply(без параметров)`
- `?raw_price(без параметров)`
- `?demand(без параметров)`
- `?production_price(без параметров)`
- `?money(один параметр, номер игрока)`
- `?raw(один параметр, номер игрока)`
- `?production(один параметр, номер игрока)`
- `?factories(один параметр, номер игрока)`
- `?manufactured(один параметр, номер игрока)`
- `?result_raw_sold(один параметр, номер игрока)`
- `?result_raw_price(один параметр, номер игрока)`
- `?result_prod_bought(один параметр, номер игрока)`
- `?result_prod_price(один параметр, номер игрока)`
