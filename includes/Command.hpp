...
public:
	...
	virtual void PrepareAndProc( int, int, int, const char*, const char*, const BCBrokerMessages& ) = 0;
	virtual void Process( int, int, const Command::CommandParams&, const BCBrokerMessages& ) = 0;
	virtual ~Command() {}
private:
...
private:
	...
	virtual void Process( int, int, const Command::CommandParams&, const BCBrokerMessages& ) override;
};
